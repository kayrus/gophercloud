...
const (
	invalidMarker           = "-1"
	jroot                   = "bgpvpn"
	jrootNetworkAssociation = "network_association"
	jrootRouterAssociation  = "router_association"
	jrootPortAssociation    = "port_association"
)
...
func (r commonNetworkAssociationResult) ExtractInto(v any) error {
	return r.Result.ExtractIntoStructPtr(v, jrootNetworkAssociation)
}
...
func (r commonRouterAssociationResult) ExtractInto(v any) error {
	return r.Result.ExtractIntoStructPtr(v, jrootRouterAssociation)
}
...
func (r commonPortAssociationResult) ExtractInto(v any) error {
	return r.Result.ExtractIntoStructPtr(v, jrootPortAssociation)
}
